...
class Pause:
    def __init__(self):
        ...
        self._draw_pause_icon(self.pause_btn_surf)
    ...
    def _draw_pause_icon(self, surf):
        surf.fill((0, 0, 0, 0))
    ...
    def show_menu(self, screen):
        ...
        self.resume_button = Button(btn_img, cx, title_rect.bottom + 60, "Resume", font=pygame.font.SysFont("Arial", 28), text_color=(20,20,20), hover_color=(80,80,80))
        self.menu_button   = Button(btn_img, cx, title_rect.bottom + 130, "Main Menu", font=pygame.font.SysFont("Arial", 28), text_color=(20,20,20), hover_color=(80,80,80))
        ...
        while True:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    return "menu"    # or "quit" if you want window X to quit the whole app
